...
### 15. Input Boundary：Requestモデル設計📥
...
### 21. UseCaseの失敗を“境界で扱う”設計にする⚠️➡️🚧
...
### 25. Repository Port設計（最小メソッド主義）🗄️✨
...
### 30. Inbound Adapter（Controller）は責務3つだけ🧻
...
### 32. Output Boundary：Presenter（出力変換口）を作る🎨
...
### 35. Outbound Adapter：InMemory Repository実装🧺✅
...
### 36. Outbound Adapter：永続化Repository（SQLite等）🗃️✅
...
### 43. Composition Rootとは（依存を一箇所で組む）🧩
